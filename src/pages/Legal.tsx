        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
          <LegalCard
            ...
            description={
              <>
                <Paragraph>
                  Pirata Amnis functions as a search engine and content
                ...
                <Link to="/about">Learn more about how Pirata Amnis works</Link>
              </>
            }
          />
          ...
          <LegalCard
            ...
            description={
              <Paragraph>
                ...
                <br />
                <br />
                Pirata Amnis is entirely self hostable, and can be run on any
          ...
          <LegalCard
            ...
            description={
              <Paragraph>
                Pirata Amnis is licensed under the MIT license.
                <br />
                <br />
          ...
          <LegalCard
            ...
            description={
              <Paragraph>
                ...
                <br />
                <br />
                Pirata Amnis operates within legal boundaries and cooperates
